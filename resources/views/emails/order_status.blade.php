...
<body>
    <table style="width: 700px">
        ...
        <tr>
            <td>Your order <strong><u>#{{$order_id}}</u></strong> status has been updated to <strong><u>{{$order_status}}</u></strong>. Your order details are as below:- </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
		...
		<tr><td>&nbsp;</td></tr>
		<tr><td>Courier Name is <strong><u>{{ $courier_name }}</u></strong> and Tracking Number is <strong><u>{{ $tracking_number }}</u></strong></td></tr>
		@endif
        <tr>
            <td>&nbsp;</td>
        </tr>
